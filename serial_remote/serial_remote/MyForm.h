...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label10->Text = L"Ответ ардуины";
			// 
			// MyForm
			// 
...
void keycheck(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) {
	//проверка на ввод не цифровых символов в текстовые поля
...
private: System::Void MyForm_Load(System::Object^  sender, System::EventArgs^  e) {
	//установим значения переменных позиций сервоприводов
